...
export default function Inventory() {
  ...
  // 1. Define the default state (usually the lowest tier)
  let features = {
    label: "Free Trial",
    maxProducts: 2,
    canExport: false,
  ...
  // 2. Use a switch to override if the plan is higher
  switch (plan) {
    case "Pro":
      features = {
        label: "Pro",
    ...
    // No need for a "Free Trial" case because it's our default above
  }
        ...
        <div className="max-w-[1600px] mx-auto p-2 md:p-6 space-y-8 bg-[#FDFDFF] min-h-screen">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-4 border-b border-slate-100 pb-6">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => {
                  if (features.maxProducts !== Infinity && products.length >= features.maxProducts) {
                    alert(`Upgrade to ${plan === "Free Trial" ? "Pro" : "Enterprise"} to add more than ${features.maxProducts} products!`);
                    return;
                  }
              ...
              <button
                onClick={() => {
                  if (!features.canPrintBarcodes) {
                    alert(`Upgrade to ${plan === "Free Trial" ? "Pro" : "Enterprise"} to print barcodes!`);
                    return;
                  }
