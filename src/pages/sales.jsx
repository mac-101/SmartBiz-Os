...
export default function Sales() {
  ...
  }, [sales, timeFilter, productFilter]);
  ...
  return (
    <div className="p-4 md:rounded-2xl md:p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-4">
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-4 rounded-2xl shadow-lg min-w-[180px]">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs opacity-80 mt-1">{getTimeFilterLabel()}</p>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-4 rounded-2xl shadow-lg min-w-[180px]">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-xs opacity-80 mt-1">{filteredSales.length} transactions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">Filter & Sort Sales</h3>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 ${
                          sale.product.includes('Laptop') ? 'bg-blue-100' :
                          ...
                          <svg className={`w-5 h-5 ${
                            sale.product.includes('Laptop') ? 'text-blue-600' :
